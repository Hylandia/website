...
export function Footer() {
  ...
  const socialLinks = [
    {
      name: "X (Twitter)",
      url: "https://twitter.hylandia.net",
      icon: (
    ...
    {
      name: "Bluesky",
      url: "https://bluesky.hylandia.net",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "Instagram",
      url: "https://instagram.hylandia.net",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "YouTube",
      url: "https://youtube.hylandia.net",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "Discord",
      url: "https://discord.hylandia.net",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <footer className="w-full bg-neutral border-t-2 border-accent/40 shadow-[0_-4px_12px_rgba(0,0,0,0.4)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-white/60 text-sm leading-relaxed">
              A progressive minigames server for Hytale where your progress
