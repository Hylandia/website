    ...
    <div className="mt-8">
      ...
      <div className="mt-6 flex flex-col md:grid md:grid-cols-3 gap-4">
        <motion.button
          ...
          className="flex items-center justify-center gap-2 bg-white/5 hover:bg-white/10 border-2 border-white/20 py-3 text-white font-semibold transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-[inset_0_2px_4px_rgba(0,0,0,0.3)] uppercase tracking-wide text-xs"
        >
          <svg
